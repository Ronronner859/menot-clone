          ...
          <div class="flex items-center space-x-6">
            ...
            <div class="flex items-center space-x-6">
              <div class="relative group">
                <NuxtLink to="/sitemap" class="text-white hover:text-gray-200 text-sm font-medium flex items-center">
                  Stores
                </NuxtLink>
              </div>
            </div>
...
const recentSearches = ref(['Amazon', 'How to Save the Most with RetailMeNot'])
